...
# Dibuat oleh Alvin Aprianto
# Diedit oleh Zulfahmi Trimahardika
...
def selesai3():
    intructions.config(text="Terima kasih sudah melakukan absensi")
def rekamDataWajah():
    wajahDir = 'datawajah'
...
canvas.configure(bg="#242526")

# Header
judul = tk.Label(root, text="Selamat Datang", font=("Roboto", 26), bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)

# Judul
made = tk.Label(root, text="Smart Attendance", font=("Times New Roman", 13), bg="#242526", fg="white")
canvas.create_window(360, 20, window=made)

# Entry data nama
entry1 = tk.Entry(root, font=("Roboto", 12))
canvas.create_window(457, 170, height=25, width=411, window=entry1)
label1 = tk.Label(root, text="Nama Mahasiswa", font=("Roboto", 12), fg="white", bg="#242526")
canvas.create_window(90, 170, window=label1)

# Entry data nim
entry2 = tk.Entry(root, font=("Roboto", 12))
canvas.create_window(457, 210, height=25, width=411, window=entry2)
label2 = tk.Label(root, text="NIM", font=("Roboto", 12), fg="white", bg="#242526")
canvas.create_window(60, 210, window=label2)

# Entry data kelas
entry3 = tk.Entry(root, font=("Roboto", 12))
canvas.create_window(457, 250, height=25, width=411, window=entry3)
label3 = tk.Label(root, text="Kelas", font=("Roboto", 12), fg="white", bg="#242526")
canvas.create_window(65, 250, window=label3)

global instructions

# Tombol untuk rekam data wajah
intructions = tk.Label(root, font=("Roboto", 12), fg="green", bg="#242526", pady=10)
canvas.create_window(370, 300, window=intructions)
Rekam_text = tk.StringVar()
Rekam_btn = tk.Button(
    root,
    textvariable=Rekam_text,
    font=("Roboto", 12),
    bg="#20bebe",
    fg="white",
    height=2,
...
Rekam_btn.grid(column=0, row=7, pady=10)

# Tombol untuk training wajah
Rekam_text1 = tk.StringVar()
Rekam_btn1 = tk.Button(
    root,
    textvariable=Rekam_text1,
    font=("Roboto", 12),
    bg="#20bebe",
    fg="white",
    height=2,
...
Rekam_btn1.grid(column=1, row=7, pady=10)

# Tombol absensi dengan wajah
Rekam_text2 = tk.StringVar()
Rekam_btn2 = tk.Button(
    root,
    textvariable=Rekam_text2,
    font=("Roboto", 12),
    bg="#20bebe",
    fg="white",
    height=2,
...
Rekam_btn2.grid(column=2, row=7, pady=10)
